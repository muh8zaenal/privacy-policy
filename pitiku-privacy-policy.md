# Privacy Policy - Pitiku

**Last Updated: May 25, 2026**

This Privacy Policy describes how **Pitiku** ("the App") handles your information. Pitiku is a personal finance management application designed to be private and secure.
...
Pitiku is designed to keep your data local. We do not host your financial data on our own servers.
...
1.  **Locally:** On your device (Primary storage).
2.  **Google Drive:** Only if you manually trigger a "Backup to Drive" (Secondary storage).
...
1.  Using the "Reset Data" feature in the App Settings.
2.  Deleting the `pitiku_backup.json` file from your Google Drive.
...
Pitiku dirancang untuk menjaga privasi data Anda. Kami tidak menyimpan data keuangan Anda di server kami sendiri.
...
1.  **Lokal:** Di perangkat Anda (Penyimpanan utama).
2.  **Google Drive:** Hanya jika Anda menekan tombol "Backup ke Drive" secara manual (Penyimpanan sekunder).
...
1.  Menggunakan fitur "Reset Data" di Pengaturan Aplikasi.
2.  Menghapus file `pitiku_backup.json` dari Google Drive Anda.
3.  Menghapus (Uninstall) Aplikasi.

---

## Contact / Kontak
If you have any questions, please contact the developer via GitHub Issues.
Jika ada pertanyaan, silakan hubungi pengembang melalui GitHub Issues.
